...
// Here we are verifying Expected text by capturing text with 'get.Text()' method. And will verify it against ExpectedResult String we have declared.
        ...
        String ExpectedResult = "If your account exists, we’ll send you a reset link.";
        
        String ActualResult = driver.findElement(By.xpath("//p[contains(text(),'Reset link is sent']")).getText();
