...
public class AmazonAddtoCart {
	...
	public static void main(String[] args) throws InterruptedException {
        ...
        driver.findElement(By.xpath("//input[@id='email' and @placeholder = 'Enter your email address']")).sendKeys("katretejal@gmail.com");
        
        
        Thread.sleep(5000);
        
        driver.findElement(By.xpath("//input[@id='password' and @placeholder = 'Enter your password']")).sendKeys("tejalk1234");
        
        Thread.sleep(5000);
        
        driver.findElement(By.xpath("//button[@type = 'submit']")).click();
        
           // To assert image element after loging in, we are capturing it in webelement and then verified using softAssert.
        
           WebElement expectedE = driver.findElement(By.xpath("//img[@clssName='w-20 mx-auto mb-6 rounded-full md:mx-0']"));
                
           SoftAssert softAssert = new SoftAssert();
           
           softAssert.assertTrue(expectedE.isDisplayed(), "WebElement is not displayed");
